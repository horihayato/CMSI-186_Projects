...
public class CalendarStuffTester {
   ...
   */
   static void test_dateEquals() {
      ...
      try { System.out.println( CalendarStuff.dateEquals(  2, 28, 2004, 2, 29, 2005 ) ? "equal" : "not equal" ); }
      catch( Exception e ) { System.out.println( false ); }
      ...
      try { System.out.println( CalendarStuff.dateEquals(  2, 20, 2000, 1, 20, 2001 ) ? "equal" : "not equal" ); }
      catch( Exception e ) { System.out.println( false ); }
   ...
   */
   static void test_compareDate() {
      ...
      System.out.print( "   Test Ides of March 2005 with Ides of March 2005  : " );
      try { System.out.println(  1 == CalendarStuff.compareDate(  3, 16, 2005,  3, 15, 2005 ) ? "first >  second" : "et tu Brute" ); }
      catch( Exception e ) { System.out.println( false ); }
   }
