...
public class StringStuffTester {
   ...
   */
   public static void test_oddsOnly() {
      System.out.println( " One TESTS FOR oddsOnly():" );
   ...
   public static void test_reverse() {
      System.out.println( " One TESTS FOR reverse():" );
   ...
   public static void test_oddsOnlyNoDupes() {
      System.out.println( " One TESTS FOR oddsOnlyNoDupes():" );
   ...
   */
   public static void test_evensOnlyNoDupes() {
      System.out.println( " One TESTS FOR evensOnlyNoDupes():" );
